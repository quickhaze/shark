...
""" Write a program to calculate sum of series(1/1!+1/2!+1/3!1/4!+1/5!....). """,
""" Write a program to calculate sum digits of a number. """,
""" Write a program that accepts marks of five subjects from user and calculate the total marks and then 						calculate the subject perccentage out of 500. """,
""" Write a program convert keys into values and values into keys in dictionary. """,
""" Write a program to compare two list and print all common numbers. """,
""" Write a program check whether year is leap year or not. """,
]
