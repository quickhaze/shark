...
class ProjectDeveloperSerializer(serializers.ModelSerializer):
    ...
    def to_representation(self, instance):
        ...
        data['developer']=Developer.objects.get(pk=instance.developer_id).user.username
        new=[]
...
class RoleInProjectSerializer(serializers.ModelSerializer):
    ...
    def to_representation(self, instance):
        data=super().to_representation(instance)
        data['projectdeveloper']=ProjectDeveloper.objects.get(pk=instance.projectdeveloper_id).project.cracker.user.username
    ...
    def get_developer(self,obj):
        ...
        for new in data:
            ...
            for j in range(len(abc)):
                if abc[j]["developer_name"]==new.projectdeveloper.developer.user.username:
